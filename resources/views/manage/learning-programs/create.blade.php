    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{route('learning-programs.store')}}" method="POST" class="quill-form"  enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-3">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <label for="working_program" class="form-label">Аннотация учебной программы</label>
                                <div class="quill"></div>
                                <input type="hidden" name="annotation" id="quill-html">
                            </div>
                        </div>
