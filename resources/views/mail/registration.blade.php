...
{{--</head>--}}
{{--<body>--}}
{{--<h1>Здравствуйте, {{ $content['user']->surname }} {{\Illuminate\Support\Str::take($content['user']->name, 1)}}. {{\Illuminate\Support\Str::take($content['user']->patron, 1)}}.</h1>--}}
{{--<p>Ваш пароль: {{ $content['password'] }}</p>--}}
{{--<p>Токен: {{ $content['token'] }}</p>--}}
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-top:24px;text-align:center;">
                                                <div align="center" class="alignment"><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url') . '/verify/' . $content['token']}}" style="height:48px;width:176px;v-text-anchor:middle;" arcsize="17%" stroke="false" fillcolor="#696cff">
                                                    <w:anchorlock/>
                                                    <v:textbox inset="0px,0px,0px,0px">
                                                        <center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
                                                    <![endif]--><a href="{{config('app.url') . '/verify/' . $content['token']}}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#696cff;border-radius:8px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:8px;padding-bottom:8px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:16px;padding-right:16px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">Подтвердить почту</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
