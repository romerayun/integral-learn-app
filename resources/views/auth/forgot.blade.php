            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <p class="mb-4">Введите адрес своей электронной почты и мы отправим Вам инструкцию по сбросу пароля</p>
                    </div>
                    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('forgot-send')}}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary d-grid w-100">Отправить ссылку для сброса пароля</button>
                    </form>
